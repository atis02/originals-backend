    ...
    async create(req, res, next) {
        try {
            ...
            if (!nameTm || !nameRu || !nameEn || !categoryId) {
                return next(ApiError.badRequest('Subkategoriýa ady giriz ýada kategoriýa ýalňyş!'));
            }
            ...
            console.error(e);
            return next(ApiError.internal('Subkategoriýa döretmekde ýalňyşlyk ýüze çykdy!'));
        }
    }
