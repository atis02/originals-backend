const { Category, SubCategory, Segment } = require("../models/model");
...
class CategoryController {
  async create(req, res, next) {
    try {
      ...
      if (categoryExist) {
        return next(ApiError.badRequest("Kategoriýa eýýäm bar!"));
      }
      let fileName = null;
      if (file) {
      ...
      console.error(e);
      return next(
        ApiError.internal("Kategoriýa döretmekde ýalňyşlyk ýüze çykdy" + e)
      );
    }
  }
